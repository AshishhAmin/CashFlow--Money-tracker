        ...
        <div className="flex flex-col items-center justify-center min-h-screen p-6 relative bg-app-black">
            ...
            <div className="absolute top-0 left-0 w-full h-full overflow-hidden -z-10">
                <motion.div
                    ...
                    className="absolute -top-[10%] -right-[10%] w-[60%] h-[60%] bg-brand-blue/20 rounded-full blur-[150px]"
                />
                <motion.div
                    animate={{
                        scale: [1, 1.2, 1],
                    ...
                    className="absolute -bottom-[10%] -left-[10%] w-[50%] h-[50%] bg-neon-green/20 rounded-full blur-[120px]"
                />
            </div>
